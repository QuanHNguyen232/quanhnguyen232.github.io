    ...
    n.on("scroll", function () {
        ...
        .on("load", function () { n.trigger("scroll") }), jQuery.fn.scrollex = function (l) {
            ...
            switch (a = i++, u = jQuery.extend({
                ...
                case "top": h = function (t, e, n, i, o) { return t >= i && o >= t }; break;
                case "bottom": h = function (t, e, n, i, o) { return n >= i && o >= n }; break;
                case "middle": h = function (t, e, n, i, o) { return e >= i && o >= e }; break;
                case "top-only": h = function (t, e, n, i, o) { return i >= t && n >= i }; break;
                case "bottom-only": h = function (t, e, n, i, o) { return n >= o && o >= t }; break;
                default:
