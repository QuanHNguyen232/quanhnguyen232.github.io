...
author: Ali Aminian and Alex Xu
cover: 
olid: OL46533616M # use Open Library ID to fetch cover (if no `cover` is provided)
isbn: 9781736049129 # use ISBN to fetch cover (if no `olid` is provided, dashes are optional)
categories: machine-learning system-design interview
tags: top-100
buy_link: https://www.amazon.com/dp/1736049127
date: 2026-01-01
started: 2026-01-01
finished: 
released: 2023
stars: 4
goodreads_review: 
status: paused # options: abandoned,finished,interested,paused,queued,reading,reread
---
